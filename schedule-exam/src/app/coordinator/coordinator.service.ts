...
export class CoordinatorService {
  ...
  public getOtherAcceptedExams(professorId: number, coordinating: string): Observable<any[]> {
    const url = `${this._api.examUrl}/otherProfessors/${professorId}/${coordinating}`;
